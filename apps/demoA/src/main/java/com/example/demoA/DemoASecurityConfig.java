...
@Configuration
@EnableWebSecurity
public class DemoASecurityConfig extends WebSecurityConfigurerAdapter {

    private static final Logger logger = LoggerFactory.getLogger(DemoASecurityConfig.class);
